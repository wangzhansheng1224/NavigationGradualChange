...
-(void)createPageControl
{
    ...
    _pageControl.center=CGPointMake(WIDTH/2, _pageControl.center.y);
    _pageControl.currentPageIndicatorTintColor = [UIColor whiteColor];//当前显示页的页码颜色
    _pageControl.pageIndicatorTintColor = [UIColor clearColor];//普通模式的页码颜色
